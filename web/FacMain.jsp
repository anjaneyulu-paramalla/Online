<%-- 
    Document   : FacMain
    Created on : Mar 27, 2013, 8:09:12 PM
    Author     : Anji
--%>
        ...
        <table width="1000"  align="center" style="margin-top: -10px;margin-bottom: 0px">
            <tr>
                ...
                <td align="center" valign="top"> 
                    <!--<form action="FacLogout.jsp" method="post">
             ...
             <tr>
                <td width="800" height="400" valign="top" class="desc">
                    <%if(request.getParameter("outInFrame")!=null){%>
                        <iframe src="FacoutputFrame.jsp?<%=request.getQueryString()%>" name="bottom" height="400" width="800" ></iframe>
                    <%}
                    else{%>
                        <iframe src="FacHome.jsp" name="bottom" height="400" width="800" ></iframe>
                    <%}%>
                </td>
                ...
                <td valign="top" align="center" class="login"  >
                    <table >
                        <tr><td>
                                <form  action="FacHome.jsp" target="bottom">
                        ...
                        <tr /><tr />
                        <tr><td>
                                <form action="FacDetails.jsp" target="bottom" >
                        ...
                        <tr /><tr />
                         <!--<tr><td>
                                 <form action="FacQuestions.jsp" target="bottom" >
                         ...
                         <tr /><tr />-->
                         <tr><td>
                                 <form action="FacFeedback.jsp" target="_top">
                         ...
                         <tr /><tr />
                         <tr><td>
                                 <form action="FacAccount.jsp" target="bottom" >
                         ...
                         <tr /><tr />
                         <tr><td>
                                 <form action="FacContactAdmin.jsp" target="bottom" >
                         ...
                         <tr /><tr />
                         <tr><td>
                                 <form action="FacLogout.jsp" target="_top">
