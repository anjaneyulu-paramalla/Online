<%-- 
    Document   : FacSettings
    Created on : Apr 5, 2013, 1:38:47 AM
    Author     : Anji
--%>
        ...
        <table align="center" class="edit" cellspacing="10">
            ...
            <tr>
                <td colspan="3" align="center" >
                    <form action="FacultyAList.jsp" >
                        <button type="submit" style="width: 300px">Faculty Data </button>
                    </form>
                </td>
            </tr>
            <tr />
            ...
            <noscript>
                <center>
                    ...
                    <form action="./" target="_top" method="post" >
                        <input type="hidden" name="uaccount" value="Administrator-2" /><br />
