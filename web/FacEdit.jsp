<%-- 
    Document   : FacEdit
    Created on : Mar 27, 2013, 10:05:47 PM
    Author     : Anji
--%>
<%--
    ...
    <%if(session.getAttribute("FACID")!=null && session.getAttribute("FACDEPT")!=null){
        ...
        try{
            ...
            if(request.getParameter("status")==null){
                rs=st.executeQuery("select FNAME,EMAILID,MOBILE from faculty where FID='"+fid+"'");
...
<html>
    ...
    <body>
        <br /><br />
    <center><img src="./PROGRESS/Capture.JPG" width="300px" height="300px" /></center>
    </body>
</html>
