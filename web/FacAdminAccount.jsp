<%-- 
    Document   : FacAdminAccount
    Created on : Apr 5, 2013, 1:40:48 AM
    Author     : Anji
--%>
...
<html>
    ...
    <%if(session.getAttribute("FACAID")!=null ){
        String aid=(String)session.getAttribute("FACAID");
        try{
            ...
            <table align="center" border="3"  width="400" style="border-radius:10px;background-color: #ccffcc">
                <tr><form action="FacAEdit.jsp" method="post" >
                ...
                <tr>
                    <th colspan="3" >
                        <form action="FacAEdit.jsp" method="post" >
